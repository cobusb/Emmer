defmodule EmmerNewTaskTest do
  ...
  test "mix emmer.new creates a new project with correct structure and files" do
    ...
    assert File.dir?(Path.join(@project, "content"))
    ...
    assert File.exists?(Path.join(@project, "content/index.html"))
    assert File.exists?(Path.join(@project, "content/index.yaml"))
    assert File.exists?(Path.join(@project, "content/about/about.html"))
    assert File.exists?(Path.join(@project, "content/about/about.yaml"))
    assert File.exists?(Path.join(@project, "content/blog/blog.html"))
    assert File.exists?(Path.join(@project, "content/blog/blog.yaml"))
    assert File.exists?(Path.join(@project, "content/contact/contact.html"))
    assert File.exists?(Path.join(@project, "content/contact/contact.yaml"))
